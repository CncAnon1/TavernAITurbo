...
(function () {
   ...
   * @returns {Tiktoken}
   */
  __exports.get_encoding = function (encoding, extend_special_tokens) {
    try {
      ...
      wasm.get_encoding(
        ...
        ptr0,
        len0,
        addHeapObject(extend_special_tokens)
      );
   ...
   * @returns {Tiktoken}
   */
  __exports.encoding_for_model = function (model, extend_special_tokens) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      const ptr0 = passStringToWasm0(
        model,
  ...
  class Tiktoken {
    ...
    constructor(tiktoken_bfe, special_tokens, pat_str) {
      ...
      const ret = wasm.tiktoken_new(
        ptr0,
        len0,
        addHeapObject(special_tokens),
        ptr1,
        len1
      );
    ...
    encode(text, allowed_special, disallowed_special) {
      try {
        ...
        wasm.tiktoken_encode(
          ...
          ptr0,
          len0,
          addHeapObject(allowed_special),
          addHeapObject(disallowed_special)
        );
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
    ...
    encode_with_unstable(text, allowed_special, disallowed_special) {
      try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.tiktoken_encode_with_unstable(
          retptr,
          this.ptr,
          ptr0,
          len0,
